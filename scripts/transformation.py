    ...
    for job_data in all_job_data:
        for job in job_data.get("data", []):
            ...
            listing_date = (
                ...
                if listing_date_str else datetime.now()
            )
            ...
            job_info = {
                ...
                "job_location_label": job.get('jobLocation', {})
                .get('label'),
                "job_advertiser_id": job.get('advertiser', {}).get('id'),
                "request_token": job_data.get('solMetadata', {})
                .get('requestToken'),
            }
